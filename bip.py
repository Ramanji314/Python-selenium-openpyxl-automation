        ...
        if len(ele) == min_len:
            ...
            if code == None:
                ...
                try:
                    ...
                    path2 = "C:/Users/Hxtreme/Downloads/"+ name
                    driver.get(path)
                    time.sleep(2)
                    ...
                    time.sleep(2)
                    f3_input = driver.find_element_by_xpath('//*[@id="nova"]/div/div[2]/div[2]/div[2]/form/div[1]/div/div[4]/div[2]/div/input[2]')
                    f3_input.click()
                    f3_output = driver.find_element_by_xpath("//span[@aria-label='September 29, 2022']")
                    f3_output.click()
